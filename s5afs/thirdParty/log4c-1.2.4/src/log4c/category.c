...
//Netbric add a defaut root category, LiuLele, 2014.10.16
static log4c_category_t* root_category;
__attribute__((constructor))							
	static void __init_root_category(void)						
{														
	root_category = log4c_category_get("root");	
}	
__attribute__((weak))
	log4c_category_t* get_category() 
{
