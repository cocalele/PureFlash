...
static void destroy_workerlist(s5_dlist_head_t *worker_list);
static void destroy_cndctlist(s5_dlist_head_t *conductor_list);
static int check_if_has_master(s5_dlist_head_t cndctlist);
 ...
 *
 * @param[in] cndctlist s5_dlist_head_t, conductor list
 *
 * @retval  return OK if there is a master conductor, otherwize return ERROR
 */
int check_if_has_master(s5_dlist_head_t cndctlist)
{
...
void destroy_cndctlist(s5_dlist_head_t *conductor_list)
{
    s5_dlist_entry_t *pos;
    s5_dlist_entry_t *n;
    cndct_self_t *tmp_clnt = NULL;
...
void destroy_workerlist_ulc(s5_dlist_head_t *worker_list)
{
	s5_dlist_entry_t *pos;
    s5_dlist_entry_t *n; 
...
void destroy_workerlist(s5_dlist_head_t *worker_list)
{
