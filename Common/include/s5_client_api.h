...
#define s5_io_submit_read(v, buf, len, off, cbk, arg)  s5_io_submit(v, buf, len, off, cbk, arg, 0)
#define s5_io_submit_write(v, buf, len, off, cbk, arg)  s5_io_submit(v, buf, len, off, cbk, arg, 1)
